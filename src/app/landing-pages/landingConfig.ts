...
export const LANDING_PAGES: LandingConfig[] = [
  ...
  { slug: 'upscale-image-to-2k',           title: 'Upscale Image to 2K Online Free',                                 h1: 'Upscale Image to 2K',           description: 'Upscale images to 2K resolution online free using AI upscaling. Improve photo quality for printing, sharing, and professional use.', tool: 'remaker', mode: 'ai_upscale',   category: 'enhance', faqs: [{ q: 'Can I upscale any image to 2K?', a: 'Yes. Upload your image and the AI will enhance it towards 2K resolution depending on the original size.' }] },
  { slug: 'upscale-image-to-4k',           title: 'Upscale Image to 4K Online Free',                                 h1: 'Upscale Image to 4K',           description: 'Upscale images to 4K resolution online free. Use AI to enhance low-resolution photos to near 4K quality.',                                        tool: 'remaker', mode: 'ai_upscale',   category: 'enhance', faqs: [{ q: 'Can I upscale a photo to 4K for free?', a: 'Yes. Upload your photo and select AI-style Upscale. The tool uses Real-ESRGAN to improve resolution up to 4x.' }] },
  { slug: 'upscale-image-to-8k',           title: 'Upscale Image to 8K Online Free',                                 h1: 'Upscale Image to 8K',           description: 'Upscale images towards 8K quality online free. AI-powered enhancement for the sharpest possible output.',                                          tool: 'remaker', mode: 'ai_upscale',   category: 'enhance', faqs: [{ q: 'Can I really get 8K quality from a small photo?', a: 'The tool upscales as much as possible using AI. True 8K depends on the original image quality and detail.' }] },

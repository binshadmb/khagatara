...
export default function FreeNumerologyReadingArPage() {
  ...
  return (
    <main className="page" dir="rtl">
      <div className="header">
        <h1>قراءة الأرقام المجانية</h1>
        <p>اكتشف رقم مسار حياتك وبرجك القمري الفيدي ونجم ميلادك فوراً</p>
      </div>
      ...
      <div className="card">
        ...
        <button className="btn-primary" onClick={calculate} disabled={loading}>
          {loading ? 'جارٍ الحساب...' : 'احسب أرقامي'}
        </button>

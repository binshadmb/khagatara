...
export default function NumerologyCompatibilityArPage() {
  ...
  return (
    <main className="page" dir="rtl">
      <div className="header">
        <h1>توافق الأرقام — اكتشف تناغمك</h1>
        <p>اكتشف التناغم العددي بينك وبين شريكك أو صديقك أو شريك عملك</p>
      </div>
      ...
      <div className="card">
        ...
        <button className="btn-primary" onClick={calculate} disabled={loading}>
          {loading ? 'جارٍ الحساب...' : 'تحقق من توافقي'}
        </button>

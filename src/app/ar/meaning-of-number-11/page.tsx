...
export default function MeaningOfNumber11ArPage() {
  ...
  return (
    <main className="page" dir="rtl">
      <div className="header">
        <h1>معنى رقم 11 — الرقم الرئيسي</h1>
        <p>اكتشف ما إذا كان رقم 11 يظهر في مسار حياتك وما يعنيه روحياً ومهنياً</p>
      </div>
      ...
      <div className="card">
        ...
        <button className="btn-primary" onClick={calculate} disabled={loading}>
          {loading ? 'جارٍ الحساب...' : 'اكتشف رقمي'}
        </button>

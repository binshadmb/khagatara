...
export default function NumerologyByNameArPage() {
  ...
  return (
    <main className="page" dir="rtl">
      <div className="header">
        <h1>علم الأرقام حسب الاسم</h1>
        <p>اكتشف رقم اسمك ورقم رغبة روحك ورقم شخصيتك</p>
      </div>
      ...
      <div className="card">
        ...
        <button className="btn-primary" onClick={calculate} disabled={loading}>
          {loading ? 'جارٍ الحساب...' : 'احسب رقم اسمي'}
        </button>

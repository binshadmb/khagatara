...
export default function FreeVedicAstrologyArPage() {
  ...
  return (
    <main className="page" dir="rtl">
      <div className="header">
        <h1>الفلك الفيدي المجاني — جيوتيش</h1>
        <p>احصل على قراءة فلكية فيدية مجانية مع البرج القمري والنكشاترا وفترة داشا</p>
      </div>
      ...
      <div className="card">
        ...
        <button className="btn-primary" onClick={calculate} disabled={loading}>
          {loading ? 'جارٍ الحساب...' : 'احصل على قراءتي الفيدية'}
        </button>

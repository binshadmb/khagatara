...
export default function FreeBirthChartArPage() {
  ...
  return (
    <main className="page" dir="rtl">
      <div className="header">
        <h1>خريطة الميلاد المجانية — كوندالي الفيدية</h1>
        <p>خريطة ميلادك هي خريطة فريدة للسماء في لحظة ولادتك</p>
      </div>
      ...
      <div className="card">
        ...
        <button className="btn-primary" onClick={calculate} disabled={loading}>
          {loading ? 'جارٍ الحساب...' : 'أنشئ خريطة ميلادي'}
        </button>

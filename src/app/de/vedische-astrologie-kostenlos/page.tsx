...
export default function VedischeAstrologieKostenlosPage() {
  ...
  return (
    <main className="page">
      <div className="header">
        <h1>Vedische Astrologie Kostenlos</h1>
        <p>Entdecken Sie Ihr Jyotish-Mondzeichen, Nakshatra und aktuelles Dasha gratis</p>
      </div>
      ...
      <div className="card">
        ...
        <button className="btn-primary" onClick={calculate} disabled={loading}>
          {loading ? 'Berechne...' : 'Mein Jyotish berechnen'}
        </button>

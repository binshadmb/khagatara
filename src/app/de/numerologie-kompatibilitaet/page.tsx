...
export default function NumerologieKompatibilitaetPage() {
  ...
  return (
    <main className="page">
      <div className="header">
        <h1>Numerologie Kompatibilität</h1>
        <p>Entdecken Sie die numerologische Harmonie zwischen Ihnen und Ihrem Partner</p>
      </div>
      ...
      <div className="card">
        ...
        <button className="btn-primary" onClick={calculate} disabled={loading}>
          {loading ? 'Berechne...' : 'Meine Kompatibilität prüfen'}
        </button>

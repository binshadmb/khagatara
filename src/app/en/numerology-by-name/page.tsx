...
export default function NumerologyByNamePage() {
  ...
  return (
    <main className="page">
      <div className="header">
        <h1>Numerology By Name — What Your Name Reveals</h1>
        <p>Your full name carries a unique vibration — discover your Expression and Soul Urge numbers</p>
      </div>

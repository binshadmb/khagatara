  ...
  return (
    <main className="page">
      <div className="header">
        <h1>Numerology Compatibility — Find Your Match</h1>
        <p>Discover the numeric harmony between you and your partner, friend or business associate</p>
      </div>
      ...
      <div className="card">
        ...
        <button className="btn-primary" onClick={calculate} disabled={loading}>
          {loading ? 'Calculating...' : 'Check My Compatibility'}
        </button>

...
export default function FreeNumerologyReadingPage() {
  ...
  return (
    <main className="page">
      <div className="header">
        <h1>Free Numerology Reading</h1>
        <p>Discover your Life Path Number, Vedic Moon Sign and Birth Nakshatra instantly</p>
      </div>

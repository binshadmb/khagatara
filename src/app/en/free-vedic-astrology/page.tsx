...
export default function FreeVedicAstrologyPage() {
  ...
  return (
    <main className="page">
      <div className="header">
        <h1>Free Vedic Astrology Reading</h1>
        <p>Discover your Jyotish Moon Sign, Nakshatra and current Dasha period instantly</p>
      </div>
      ...
      <div className="card">
        ...
        <button className="btn-primary" onClick={calculate} disabled={loading}>
          {loading ? 'Calculating...' : 'Calculate My Vedic Chart'}
        </button>

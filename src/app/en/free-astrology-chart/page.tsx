...
export default function FreeAstrologyChartPage() {
  ...
  return (
    <main className="page">
      <div className="header">
        <h1>Free Astrology Chart — Vedic Reading</h1>
        <p>Get your free Vedic astrology chart with Moon sign, Nakshatra and planetary periods</p>
      </div>
      ...
      <div className="card">
        ...
        <button className="btn-primary" onClick={calculate} disabled={loading}>
          {loading ? 'Calculating...' : 'Get My Astrology Chart'}
        </button>
